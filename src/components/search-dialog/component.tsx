...
import {
  useSearchYoutube,
  SearchResult,
} from "../../api/mutations/useSearchYoutube";
...
export const SearchDialog = ({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-purple-900/80 via-indigo-900/80 to-blue-900/80 backdrop-blur-sm flex items-center justify-center p-8">
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl w-full max-w-2xl border border-white/20">
        ...
        <div className="p-6 space-y-6">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent text-white placeholder-white/40"
            />
            <button
